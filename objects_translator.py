...
def translate(file_path, src='it', dst='en', verbose=False, max_retries=5, max_len=55):

    def translate_sentence(text):
        target = text
        translation = tr_manager(text, src, dst)
...
if __name__ == '__main__':
    ...
    for file in os.listdir(args.input_folder):
        ...
        if file.endswith('.json'):
            ...
            new_data, t = translate(file_path, max_len=args.max_len,
